...
namespace FigureTask
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var Figure1 = new List<Figure>() { triangle11, triangle12, retangle11 };

            foreach (var figure in Figure1) 
            {
            ...
            var Figure2 = new List<Figure>() { retangle21, retangle22, triangle21 };

            foreach (var figure in Figure2) 
            {
                areaOfTheFirstFigure += figure.GetArea();
            }
